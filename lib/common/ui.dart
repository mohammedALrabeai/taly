...
class Ui {
    ...
    try {
      ...
      return RichText(
        ...
        text: _setting.setting.value.currencyRight != null && _setting.setting.value?.currencyRight == false
            ? TextSpan(
                text: _setting.setting.value?.defaultCurrency.tr,
  ...
  static InputDecoration getInputDecoration({String hintText = '', String errorText, IconData iconData, Widget suffixIcon,Widget perffixIcon, Widget suffix}) {
    return InputDecoration(
      hintText: hintText,
      hintStyle: Get.textTheme.caption,
      prefixIcon:perffixIcon!=null?perffixIcon:( iconData != null ? Icon(iconData, color: Get.theme.focusColor).marginOnly(right: 14) : const SizedBox()),
      prefixIconConstraints: iconData != null ? const BoxConstraints.expand(width: 38, height: 38) :perffixIcon==null? const BoxConstraints.expand(width: 0, height: 0):const BoxConstraints.expand(width: 120, height: 58) , floatingLabelBehavior: FloatingLabelBehavior.never,
