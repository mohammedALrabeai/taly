        ...
        children: [
          BookingRowWidget(
            ...
            child: Align(
              ...
              // Ui.getPrice(_booking.price, style: Get.textTheme.subtitle2),
            ),
            hasDivider: true,
          ),
          BookingRowWidget(
          ...
          Column(
            children: List.generate(0/*_booking.options.length*/, (index) {
          ...
          if (true || _booking.eService.priceUnit == 'fixed')
            BookingRowWidget(
                ...
                hasDivider: true),
          Column(
            children: List.generate(0/*_booking.taxes.length*/, (index) {
          ...
          BookingRowWidget(
            ...
            child: Align(
              alignment: Alignment.centerRight,
              child: Ui.getPrice(0/*_booking.getTaxesValue()*/, style: Get.textTheme.subtitle2),
            ),
            hasDivider: false,
          ),
          // BookingRowWidget(
          ...
          //     child: Align(
          //       alignment: Alignment.centerRight,
          //       child: Ui.getPrice(30/*_booking.getSubtotal()*/, style: Get.textTheme.subtitle2),
          //     ),
          //     hasDivider: true),
          ...
          BookingRowWidget(
            ...
            child: Align(
              alignment: Alignment.centerRight,
              child: Ui.getPrice(_booking.total/*_booking.getTotal()*/, style: Get.textTheme.headline6),
            ),
          ),
        ],
      ),
