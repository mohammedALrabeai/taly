...
class BookingSummaryView extends GetView<BookEServiceController> {
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text("الطلب إلى ".tr, style: Get.textTheme.bodyText1),
                  SizedBox(height: 8),
                  Row(
                    children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("ملاحظاتك ".tr, style: Get.textTheme.bodyText1),
                  SizedBox(height: 8),
                  Row(
                    children: [
  ...
  Widget buildBottomWidget(Booking _booking) {
    var total = controller.currentSizeId.value.price*controller.quantity.value;
    _booking.total = total;
    _booking.talyName = controller.currentSizeId.value.name;
    _booking.price = controller.currentSizeId.value.price;
    _booking.quantity = controller.quantity.value;
    return Container(
