...
class EServiceViewOld extends GetView<EServiceController> {
  @override
            ...
            child: RefreshIndicator(
                ...
                child: CustomScrollView(
                  ...
                  slivers: <Widget>[
                    ...
                    //               Image.asset("assets/img/icon.png"):Image.asset("assets/img/icon.png"),
                    //           // Text("hjhdsdk"):Text("hjhk"),
                    //           // buildCarouselSlider(_eService):Text("hjhk"),
                    ...
                    SliverToBoxAdapter(
                      child: Column(
                        ...
                        children: [
                          ...
                          EServiceTilWidget(
                            decore: false,
                            title: Text("التطبيق الأفضل لطلب اللحوم الطازجة".tr, style: Get.textTheme.subtitle2),
                            content: SizedBox(
                              height: 20,
                          ...
                          ListTile(
                            ...
                            subtitle: Text(
                              ...
                              style: Get.textTheme.caption
                                  .merge(TextStyle(color: mcolor, fontSize: 15)),
                            ),
                          ),
                          ...
                          if (false &&_eService.images.isNotEmpty)
                            EServiceTilWidget(
                              horizontalPadding: 0,
            ...
            children: [
              Expanded(
                child: Wrap(
                  ...
                  children: List.from(Ui.getStarsList(0))
                    ..addAll([
                      SizedBox(width: 5),
                      Text(
                        "Reviews (%s)".trArgs([_eService.totalReviews.toString()]),
  ...
  Widget buildCategories(EService _eService) {
    return Padding(
      ...
      child: Wrap(
        ...
        spacing: 5,
        runSpacing: 8,
        children: List.generate(0 /*_eService.categories.length*/, (index) {
            ...
            List.generate(0/*_eService.subCategories.length*/, (index) {
              return Container(
                padding: EdgeInsets.symmetric(horizontal: 10, vertical: 4),
  ...
  Widget buildBottomWidget(EService _eService) {
    return Container(
      ...
      child: Row(
        children: [
          if (_eService.priceUnit == 'fixed'&&false)
            Container(
              decoration: BoxDecoration(
