...
class WalletTransactionsLoadingListWidgetMain extends StatelessWidget {
  const WalletTransactionsLoadingListWidgetMain({
    Key key, this.count=3,
  }) : super(key: key);
final int count;
  @override
  Widget build(BuildContext context) {
