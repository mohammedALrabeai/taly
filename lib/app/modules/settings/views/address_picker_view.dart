...
class AddressPickerView extends StatelessWidget {
  AddressPickerView({this.back=false});
  bool back;
  String disc = "";
  @override
  Widget build(BuildContext context) {

    // print('keeeyy ${Get.find<SettingsService>().setting.value.googleMapsKey}');
    return PlacePicker(
                  ...
                  children: [
                    ...
                    BlockButtonWidget(
                      onPressed: () async {
                        ...
                        if (disc != null && !disc.isEmpty && disc != "")
                          db.saveMyLocation(Address(
                              description: disc,
