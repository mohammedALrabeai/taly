...
import '../modules/auth/views/login_view2.dart';
...
class Theme1AppPages {
  static const INITIAL = Routes.E_SERVICE;
  ...
  static final routes = [
    ...
    GetPage(name: Routes.LOGIN, page: () => LoginView2(), binding: AuthBinding(), transition: Transition.zoom),
