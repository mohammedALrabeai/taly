...
class Category extends Model {
  ...
  bool featured;
  String select;
  List<SizeObtion> sizeObtions;
  List<CutObtion> cutObtions;
  List<Category> subCategories;
  List<EService> eServices;

  Category({this.id, this.name, this.description, this.color, this.image, this.featured, this.subCategories, this.eServices,this.sizeObtions,this.cutObtions});
 ...
 class SizeObtion extends Model{
  String id;
  String name;
  double price;

  SizeObtion({this.id, this.name, this.price});
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = Map<String, dynamic>();
    data['id'] = this.id;
    data['name'] = this.name;
...
class CutObtion extends Model{
  String id;
  String name;
  double price;

  CutObtion({this.id, this.name, this.price});
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = Map<String, dynamic>();
    data['id'] = this.id;
    data['name'] = this.name;
