...
class Address extends Model {
  ...
  Address.fromJson2(Map<String, dynamic> json) {
    ...
    description = stringFromJson(json, 'description');
    address = stringFromJson(json, 'address');
    latitude = doubleFromJson(json, 'latitude', defaultValue: null,decimal: 20);
    longitude = doubleFromJson(json, 'longitude', defaultValue: null,decimal: 20);
    isDefault = boolFromJson(json, 'defaults');
    // userId = stringFromJson(json, 'user_id');
  }
  ...
  LatLng getLatLng() {
    if (this.isUnknown()) {
      return LatLng(26.420688, 50.08887910000001);
    } else {
